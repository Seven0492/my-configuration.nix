...

{
  ...
  networking.hostName = "lazycat"; # Define your hostname.
  ...
  users.extraGroups.docker.members = [ "sethm" ];

  # Enable VirtualBox
  virtualisation.virtualbox.host.enable = true;
  users.extraGroups.vboxusers.members = [ "sethm" ];
